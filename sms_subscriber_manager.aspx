<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sms_subscriber_manager.aspx.cs" Inherits="DBProject.sms_subscriber_manager" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title> Sms Subscriber Manager</title>
...
<body style="background-color: #777777; background-image: url('./images/bg1.jpg'); background-repeat: no-repeat; background-size: 100% 100%; background-attachment: fixed;">
    ...
    <div>
        <h3 style="color:green; font-size:40px; text-align:center; opacity: 1;"> SMS TABLE </h3>    
...
<EditRowStyle BackColor="#7C6F57" />
	        ...
	        <EditItemTemplate>
	        <asp:TextBox ID="txtfname_id" runat="server" Text='<%# Bind("fname") %>'></asp:TextBox>
	        </EditItemTemplate>
	        <ItemTemplate>
	        <asp:Label ID="lblfname_id" runat="server" Text='<%# Bind("fname") %>'></asp:Label>
	        </ItemTemplate>
	        <HeaderStyle HorizontalAlign="center"></HeaderStyle>
            </asp:TemplateField>
	        ...
	        <EditItemTemplate>
	        <asp:TextBox ID="txtlname_id" runat="server" Text='<%# Bind("lname") %>'></asp:TextBox>
	        </EditItemTemplate>
	        <ItemTemplate>
	        <asp:Label ID="lbllname_id" runat="server" Text='<%# Bind("lname") %>'></asp:Label>
	        </ItemTemplate>
	        <HeaderStyle HorizontalAlign="center"></HeaderStyle>
            </asp:TemplateField>

                  <asp:TemplateField HeaderText="cell" HeaderStyle-HorizontalAlign="center">
	        <EditItemTemplate>
	        <asp:TextBox ID="txtcell_id" runat="server" Text='<%# Bind("cell") %>'></asp:TextBox>
	        </EditItemTemplate>
	        <ItemTemplate>
	        <asp:Label ID="lblcell_id" runat="server" Text='<%# Bind("cell") %>'></asp:Label>
	        </ItemTemplate>
	        <HeaderStyle HorizontalAlign="center"></HeaderStyle>
</asp:TemplateField>
       ...
       <div class="container">
			<table border="0" width="35%" style="margin-left:auto; margin-right:auto;">
					<td>
						<h2 style="color:black; font-size:20px; text-align:center; opacity: 1;"></td>
              	             	
					 <h4 style="text-align:left; color:black;" >To insert the data, type in the valid inputs in the following textbox and press the button</h4>
    ...
    <p> 
     ...
     <p1 style ="color:white"> lname:  </p1>  
        <asp:TextBox runat="server"  ID="insrtlname" Text="" style="margin-top: 4px" CssClass="auto-style3" ></asp:TextBox> <br/>
        <p1 style ="color:white"> cell:  </p1>
        <asp:TextBox runat="server"  ID="insertcell" Text="" style="margin-top: 4px" CssClass="auto-style6"></asp:TextBox> <br/>
      </p>    
